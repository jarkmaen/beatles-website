    ...
    return (
        <div className="flex flex-col items-center justify-center lg:-mt-[48px] lg:min-h-[calc(100vh-185px)] max-w-2xl mx-auto sm:-mt-[32px] sm:min-h-[calc(100vh-125px)]">
            ...
            <div className="-mt-10 sm:-mt-16 space-y-6 text-center z-10">
                <h2 className="dark:text-primary-dark font-bold font-lora sm:text-5xl text-3xl text-primary-light transition">
                    Page Not Found
                </h2>
                ...
                <div className="flex flex-col justify-center sm:flex-row sm:space-x-6 sm:space-y-0 space-y-4">
                    <button className="bg-primary-light cursor-pointer dark:bg-primary-dark dark:hover:bg-primary-dark/90 dark:text-black flex font-bold hover:bg-primary-light/90 justify-center px-6 py-3 rounded-md shadow-sm text-sm text-white transition">
                        <NavLink to="/">RETURN HOME</NavLink>
                    </button>
                    <button className="cursor-pointer dark:hover:bg-surface-dark dark:ring-border-dark dark:text-white flex font-bold hover:bg-gray-100 justify-center px-6 py-3 ring ring-border-light ring-inset rounded-md text-black text-sm transition">
